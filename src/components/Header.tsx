  ...
  return (
    <header className="border-b border-white/10 py-4 sticky top-0 bg-balestra-black/95 backdrop-blur-sm z-50">
      <div className="max-w-5xl mx-auto px-6 flex justify-between items-center">
        <a href="/" className="block transition-opacity hover:opacity-80 leading-none">
          <Image
            src="/header-logo.svg"
            alt="Balestra Group"
            width={200}
        ...
        <nav className="hidden md:flex gap-8 text-sm font-medium text-gray-400 items-center">
          <a href="/about" className="hover:text-balestra-red transition-colors">{t('nav.about')}</a>
          <a href="/blog" className="hover:text-balestra-red transition-colors">{t('nav.insights')}</a>
          <a
            href="/contact"
