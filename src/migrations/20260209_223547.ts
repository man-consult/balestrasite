...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`about_pillars\` (
  ...
  `)
  await db.run(sql`CREATE INDEX \`about_pillars_order_idx\` ON \`about_pillars\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`about_pillars_parent_id_idx\` ON \`about_pillars\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`about_vision_products\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`about_vision_products_order_idx\` ON \`about_vision_products\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`about_vision_products_parent_id_idx\` ON \`about_vision_products\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE TABLE \`contact_contact_methods\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`contact_contact_methods_order_idx\` ON \`contact_contact_methods\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`contact_contact_methods_parent_id_idx\` ON \`contact_contact_methods\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE TABLE \`terms_page_clauses\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`text\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`terms_page_clauses_order_idx\` ON \`terms_page_clauses\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`terms_page_clauses_parent_id_idx\` ON \`terms_page_clauses\` (\`_parent_id\`);`)
